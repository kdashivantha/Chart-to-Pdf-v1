...
namespace ChartJsToPdf.Controllers
{
    public class ChartDataController : Controller
    {
        ...
        {
            var data = @"{""labels"":[""January"",""February"",""March"",""April"",""May"",""June""],""datasets"":[{""fillColor"":""rgba(172,194,132,0.4)"",""strokeColor"":""#ACC26D"",""pointColor"":""#fff"",""pointStrokeColor"":""#9DB86D"",""data"":[203,156,99,251,305,247],""backgroundColor"":[""rgba(255, 99, 132, 1)"",""rgba(54, 162, 235, 1)"",""rgba(255, 206, 86, 1)"",""rgba(75, 192, 192, 1)"",""rgba(153, 102, 255, 1)"",""rgba(255, 159, 64, 1)""],""borderColor"":[""rgba(255,99,132,1)"",""rgba(54, 162, 235, 1)"",""rgba(255, 206, 86, 1)"",""rgba(75, 192, 192, 1)"",""rgba(153, 102, 255, 1)"",""rgba(255, 159, 64, 1)""]}]}";
